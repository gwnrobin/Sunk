...
Shader "Triplebrick/Glass_HDRP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Albedo("Albedo", Color) = (0.2113047,0,1,1)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 color224 = IsGammaSpace() ? float4(0.9009434,1,0.9716175,0) : float4(0.7892805,1,0.9366449,0);
				...
				surfaceDescription.RefractionColor = color224.rgb;
...
ASEEND*/
//CHKSM=B4F17049995D08CDD7C4CB9811A954066D5A2568