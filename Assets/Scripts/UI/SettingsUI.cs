...
public class SettingsUI : MonoBehaviour
{
    ...
    internal void Initialize()
    {
        ...
        for (int i = 0; i < GameManager.instance.searchAlgorithms.Count; i++)
            dropdownOptions.Add(GameManager.instance.searchAlgorithms[i].name);
        dropdown.AddOptions(dropdownOptions);

        // call a dropdown changed manually, since seting its options
    ...
    public void DropdownChanged()
    {
        ...
        GameManager.instance.SetCurrentSearchAlgorithm(GameManager.instance.searchAlgorithms[dropdown.value]);
    }
